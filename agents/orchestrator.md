...
- AUTONOMOUS MODE: if your brief declares it (unattended/cron/long-run), you are expected to RESOLVE forks yourself after the self-answer attempt — best judgment, recorded under "Judgment calls" — not to gate to a spawner who told you nobody is watching. Reserve gates for what the brief explicitly forbade deciding (usually irreversible/outward actions): for those, SKIP the step, flag it DEFERRED in your report, and complete everything else — never hang the run on a question.
