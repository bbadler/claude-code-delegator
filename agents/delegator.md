...
- Track trust in the registry: an agent caught overclaiming gets `staleness_flags: ["overclaimed:<what>"]` and its future reports verify one tier higher; agents with a clean verbatim-evidence record earn the fast path.
